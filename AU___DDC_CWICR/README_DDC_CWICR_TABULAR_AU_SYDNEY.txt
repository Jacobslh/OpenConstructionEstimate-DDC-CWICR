# OpenConstructionEstimate — Australia / Sydney
...
| Property | Value |
|---|---|
| Reference region | Australia / Sydney |
| ISO country | AU |
| Language | `en` |
...
| Format | File |
|---|---|
| Parquet | `AU_SYDNEY_workitems_costs_resources_DDC_CWICR.parquet` |
| Excel (formatted) | `AU_SYDNEY_workitems_costs_resources_DDC_CWICR_FORMATTED.xlsx` |
| Excel (simple) | `AU_SYDNEY_workitems_costs_resources_DDC_CWICR_SIMPLE.xlsx` |
| Catalog CSV | `DDC_CWICR_AU_SYDNEY_Catalog.csv` |
| Catalog XLSX | `DDC_CWICR_AU_SYDNEY_Catalog.xlsx` |
| Qdrant snapshot | `AU_SYDNEY_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot` |
...
qdrant-client snapshot upload \
  --collection ddc_au_sydney \
  --snapshot AU_SYDNEY_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot
```
