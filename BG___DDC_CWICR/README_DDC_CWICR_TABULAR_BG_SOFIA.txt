# OpenConstructionEstimate — Bulgaria / Sofia
...
| Property | Value |
|---|---|
| Reference region | Bulgaria / Sofia |
| ISO country | BG |
| Language | `bg` |
...
| Format | File |
|---|---|
| Parquet | `BG_SOFIA_workitems_costs_resources_DDC_CWICR.parquet` |
| Excel (formatted) | `BG_SOFIA_workitems_costs_resources_DDC_CWICR_FORMATTED.xlsx` |
| Excel (simple) | `BG_SOFIA_workitems_costs_resources_DDC_CWICR_SIMPLE.xlsx` |
| Catalog CSV | `DDC_CWICR_BG_SOFIA_Catalog.csv` |
| Catalog XLSX | `DDC_CWICR_BG_SOFIA_Catalog.xlsx` |
| Qdrant snapshot | `BG_SOFIA_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot` |
...
qdrant-client snapshot upload \
  --collection ddc_bg_sofia \
  --snapshot BG_SOFIA_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot
```
