# OpenConstructionEstimate — Indonesia / Jakarta
...
| Property | Value |
|---|---|
| Reference region | Indonesia / Jakarta |
| ISO country | ID |
| Language | `id` |
...
| Format | File |
|---|---|
| Parquet | `ID_JAKARTA_workitems_costs_resources_DDC_CWICR.parquet` |
| Excel (formatted) | `ID_JAKARTA_workitems_costs_resources_DDC_CWICR_FORMATTED.xlsx` |
| Excel (simple) | `ID_JAKARTA_workitems_costs_resources_DDC_CWICR_SIMPLE.xlsx` |
| Catalog CSV | `DDC_CWICR_ID_JAKARTA_Catalog.csv` |
| Catalog XLSX | `DDC_CWICR_ID_JAKARTA_Catalog.xlsx` |
| Qdrant snapshot | `ID_JAKARTA_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot` |
...
qdrant-client snapshot upload \
  --collection ddc_id_jakarta \
  --snapshot ID_JAKARTA_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot
```
