# OpenConstructionEstimate — Italy / Rome
...
| Format | File |
|---|---|
| Parquet | `IT_ROME_workitems_costs_resources_DDC_CWICR.parquet` |
| Excel (formatted) | `IT_ROME_workitems_costs_resources_DDC_CWICR_FORMATTED.xlsx` |
| Excel (simple) | `IT_ROME_workitems_costs_resources_DDC_CWICR_SIMPLE.xlsx` |
| Catalog CSV | `DDC_CWICR_IT_ROME_Catalog.csv` |
| Catalog XLSX | `DDC_CWICR_IT_ROME_Catalog.xlsx` |
| Qdrant snapshot | `IT_ROME_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot` |
...
qdrant-client snapshot upload \
  --collection ddc_it_rome \
  --snapshot IT_ROME_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot
```
