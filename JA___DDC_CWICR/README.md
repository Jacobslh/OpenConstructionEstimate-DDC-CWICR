# OpenConstructionEstimate — Japan / Tokyo
...
| Format | File |
|---|---|
| Parquet | `JA_TOKYO_workitems_costs_resources_DDC_CWICR.parquet` |
| Excel (formatted) | `JA_TOKYO_workitems_costs_resources_DDC_CWICR_FORMATTED.xlsx` |
| Excel (simple) | `JA_TOKYO_workitems_costs_resources_DDC_CWICR_SIMPLE.xlsx` |
| Catalog CSV | `DDC_CWICR_JA_TOKYO_Catalog.csv` |
| Catalog XLSX | `DDC_CWICR_JA_TOKYO_Catalog.xlsx` |
| Qdrant snapshot | `JA_TOKYO_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot` |
...
qdrant-client snapshot upload \
  --collection ddc_ja_tokyo \
  --snapshot JA_TOKYO_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot
```
