# OpenConstructionEstimate — South Korea / Seoul
...
| Property | Value |
|---|---|
| Reference region | South Korea / Seoul |
| ISO country | KR |
| Language | `ko` |
...
| Format | File |
|---|---|
| Parquet | `KO_SEOUL_workitems_costs_resources_DDC_CWICR.parquet` |
| Excel (formatted) | `KO_SEOUL_workitems_costs_resources_DDC_CWICR_FORMATTED.xlsx` |
| Excel (simple) | `KO_SEOUL_workitems_costs_resources_DDC_CWICR_SIMPLE.xlsx` |
| Catalog CSV | `DDC_CWICR_KO_SEOUL_Catalog.csv` |
| Catalog XLSX | `DDC_CWICR_KO_SEOUL_Catalog.xlsx` |
| Qdrant snapshot | `KO_SEOUL_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot` |
...
qdrant-client snapshot upload \
  --collection ddc_ko_seoul \
  --snapshot KO_SEOUL_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot
```
