# OpenConstructionEstimate — Mexico / Mexico City
...
| Property | Value |
|---|---|
| Reference region | Mexico / Mexico City |
| ISO country | MX |
| Language | `es` |
| Currency | `MXN` (ISO 4217) |
| Source track | `SP_BARCELONA` (Spain / Barcelona) |
...
| Format | File |
|---|---|
| Parquet | `MX_MEXICOCITY_workitems_costs_resources_DDC_CWICR.parquet` |
| Excel (formatted) | `MX_MEXICOCITY_workitems_costs_resources_DDC_CWICR_FORMATTED.xlsx` |
| Excel (simple) | `MX_MEXICOCITY_workitems_costs_resources_DDC_CWICR_SIMPLE.xlsx` |
| Catalog CSV | `DDC_CWICR_MX_MEXICOCITY_Catalog.csv` |
| Catalog XLSX | `DDC_CWICR_MX_MEXICOCITY_Catalog.xlsx` |
| Qdrant snapshot | `MX_MEXICOCITY_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot` |

## How this track was built

This track was generated from `SP_BARCELONA` by
...
qdrant-client snapshot upload \
  --collection ddc_mx_mexicocity \
  --snapshot MX_MEXICOCITY_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot
```
