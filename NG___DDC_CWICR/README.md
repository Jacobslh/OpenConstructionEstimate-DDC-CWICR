# OpenConstructionEstimate — Nigeria / Lagos
...
| Property | Value |
|---|---|
| Reference region | Nigeria / Lagos |
| ISO country | NG |
| Language | `en` |
...
| Format | File |
|---|---|
| Parquet | `NG_LAGOS_workitems_costs_resources_DDC_CWICR.parquet` |
| Excel (formatted) | `NG_LAGOS_workitems_costs_resources_DDC_CWICR_FORMATTED.xlsx` |
| Excel (simple) | `NG_LAGOS_workitems_costs_resources_DDC_CWICR_SIMPLE.xlsx` |
| Catalog CSV | `DDC_CWICR_NG_LAGOS_Catalog.csv` |
| Catalog XLSX | `DDC_CWICR_NG_LAGOS_Catalog.xlsx` |
| Qdrant snapshot | `NG_LAGOS_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot` |
...
qdrant-client snapshot upload \
  --collection ddc_ng_lagos \
  --snapshot NG_LAGOS_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot
```
