# OpenConstructionEstimate — New Zealand / Auckland
...
| Property | Value |
|---|---|
| Reference region | New Zealand / Auckland |
| ISO country | NZ |
| Language | `en` |
...
| Format | File |
|---|---|
| Parquet | `NZ_AUCKLAND_workitems_costs_resources_DDC_CWICR.parquet` |
| Excel (formatted) | `NZ_AUCKLAND_workitems_costs_resources_DDC_CWICR_FORMATTED.xlsx` |
| Excel (simple) | `NZ_AUCKLAND_workitems_costs_resources_DDC_CWICR_SIMPLE.xlsx` |
| Catalog CSV | `DDC_CWICR_NZ_AUCKLAND_Catalog.csv` |
| Catalog XLSX | `DDC_CWICR_NZ_AUCKLAND_Catalog.xlsx` |
| Qdrant snapshot | `NZ_AUCKLAND_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot` |
...
qdrant-client snapshot upload \
  --collection ddc_nz_auckland \
  --snapshot NZ_AUCKLAND_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot
```
