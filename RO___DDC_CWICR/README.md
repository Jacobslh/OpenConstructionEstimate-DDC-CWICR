# OpenConstructionEstimate — Romania / Bucharest
...
| Property | Value |
|---|---|
| Reference region | Romania / Bucharest |
| ISO country | RO |
| Language | `ro` |
| Currency | `RON` (ISO 4217) |
...
| Format | File |
|---|---|
| Parquet | `RO_BUCHAREST_workitems_costs_resources_DDC_CWICR.parquet` |
| Excel (formatted) | `RO_BUCHAREST_workitems_costs_resources_DDC_CWICR_FORMATTED.xlsx` |
| Excel (simple) | `RO_BUCHAREST_workitems_costs_resources_DDC_CWICR_SIMPLE.xlsx` |
| Catalog CSV | `DDC_CWICR_RO_BUCHAREST_Catalog.csv` |
| Catalog XLSX | `DDC_CWICR_RO_BUCHAREST_Catalog.xlsx` |
| Qdrant snapshot | `RO_BUCHAREST_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot` |
...
qdrant-client snapshot upload \
  --collection ddc_ro_bucharest \
  --snapshot RO_BUCHAREST_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot
```
