# OpenConstructionEstimate — South Africa / Johannesburg
...
| Property | Value |
|---|---|
| Reference region | South Africa / Johannesburg |
| ISO country | ZA |
| Language | `en` |
...
| Format | File |
|---|---|
| Parquet | `ZA_JOHANNESBURG_workitems_costs_resources_DDC_CWICR.parquet` |
| Excel (formatted) | `ZA_JOHANNESBURG_workitems_costs_resources_DDC_CWICR_FORMATTED.xlsx` |
| Excel (simple) | `ZA_JOHANNESBURG_workitems_costs_resources_DDC_CWICR_SIMPLE.xlsx` |
| Catalog CSV | `DDC_CWICR_ZA_JOHANNESBURG_Catalog.csv` |
| Catalog XLSX | `DDC_CWICR_ZA_JOHANNESBURG_Catalog.xlsx` |
| Qdrant snapshot | `ZA_JOHANNESBURG_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot` |
...
qdrant-client snapshot upload \
  --collection ddc_za_johannesburg \
  --snapshot ZA_JOHANNESBURG_workitems_costs_resources_EMBEDDINGS_3072_DDC_CWICR.snapshot
```
